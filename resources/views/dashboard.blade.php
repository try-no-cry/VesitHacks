                   ...
                   <div class="row">
                     ...
                     <div class="col s12 m4">
                       <div class="icon-block">
                         ...
                         <h5 class="center">Send reports</h5>
                     ...
                     <div class="col s12 m4">
                       <div class="icon-block">
                         <h2 class="center brown-text"><i class="material-icons">group</i></h2>
                         <h5 class="center">View recieved reports</h5>
                    ...
                    <div class="col s12 m4">
                       <div class="icon-block">
                         <h2 class="center brown-text"><i class="material-icons">group</i></h2>
                         <h5 class="center">Rate subordinates</h5>
                     ...
                     <div class="col s12 m4">
                       <div class="icon-block">
                         <h2 class="center brown-text"><i class="material-icons">group</i></h2>
                         <h5 class="center">View ratings</h5>
